...
## 项目简介
《绝地求生》（PUBG）是一款战术竞技类游戏，玩家需在缩小的安全区内收集资源并击败对手，最终生存者将获得“大吉大利，晚上吃鸡”的胜利。
本项目基于 150 万条真实玩家行为记录，构建预测模型来预估玩家在每局游戏中的最终队伍排名（team_placement）。我们对比了 6 种不同的模型方案，最终通过 Stacking 集成学习 取得了最优效果（R² = 0.8543）。
